...
public class deb extends javax.swing.JFrame 
{
    ...
    public deb(int id) throws Exception {
       initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "visa Electron", "MasterCard", "RuPay", "Maestro" }));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 90, 80));
        ...
        Cards.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Backgroung_Images/1-visa.jpg"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/request_d.jpg"))); // NOI18N
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        JOptionPane.showMessageDialog(this,"REQUEST FOR DEBIT CARD ["+jComboBox1.getSelectedItem().toString()+"] IS RECEIVED SUCCESSFULLY !");
        try {
            DateFormat df=new SimpleDateFormat("dd-MM-yy hh:mm:ss");
            Calendar cal=Calendar.getInstance();
            String time=df.format(cal.getTime());
            String send_msg="REQUEST FOR DEBIT CARD ["+jComboBox1.getSelectedItem().toString()+"] Of "+name;
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/vector_bank", "root", "");
            Statement st = con.createStatement();
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        switch(combo) {
            case "visa Electron" :
                ...
                ImageIcon img=new ImageIcon("F:\\SEM-4\\Advanced Java\\Vector_Bank(12-03-2018)\\src\\Backgroung_Images\\1-visa.jpg");
                Image im=img.getImage();
