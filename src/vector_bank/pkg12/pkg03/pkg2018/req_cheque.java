...
import javax.swing.JOptionPane;
public class req_cheque extends javax.swing.JFrame 
{
    ...
    public req_cheque(int id) throws Exception {
       initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "25 LEAVES", "50 LEAVES" }));
        jComboBox1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jComboBox1MouseClicked(evt);
            }
        });
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 417, 160, 30));
        ...
        getContentPane().add(request, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 560, 240, 50));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 80, 80));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Request_c.jpg"))); // NOI18N
    ...
    private void jComboBox1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jComboBox1MouseClicked
     ...
     /*   if(jComboBox1.getSelectedItem().equals(c1) && jComboBox1.getSelectedItem().equals(c2))
{
    if(jComboBox1.getSelectedItem().equals(c1))
    {
        final_request f=new final_request(c1,c2);
        f.setVisible(true);
...
else
{
    ...
    private void requestMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_requestMouseClicked
        String c1="25 LEAVES";
        String c2="50 LEAVES";
        JOptionPane.showMessageDialog(this,"REQUEST FOR "+jComboBox1.getSelectedItem().toString()+" RECEIVED SUCCESSFULLY");
        try {
            DateFormat df=new SimpleDateFormat("dd-MM-yy hh:mm:ss");
            Calendar cal=Calendar.getInstance();
            String time=df.format(cal.getTime());
            String send_msg="REQUEST FOR "+jComboBox1.getSelectedItem().toString()+"Of "+name;
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/vector_bank", "root", "");
            Statement st = con.createStatement();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(req_cheque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new req_cheque().setVisible(true);
            }
        });
    }
